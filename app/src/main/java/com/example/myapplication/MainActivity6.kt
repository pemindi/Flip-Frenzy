...
class MainActivity6 : AppCompatActivity() {
    ...
    private val images = mutableListOf(
        R.drawable.a51, R.drawable.a51,
        R.drawable.a10, R.drawable.a10,
        R.drawable.a11, R.drawable.a11,
        R.drawable.a20, R.drawable.a20,
        R.drawable.a50, R.drawable.a50,
        R.drawable.a30, R.drawable.a30
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageButton1 = findViewById<ImageButton>(R.id.imageButton16)
